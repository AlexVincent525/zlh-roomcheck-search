...
return [
    ...
    */
    'generator'  => [
        'basePath'      => app_path(),
        'rootNamespace' => 'App\\ScoreCheck',
        'paths'         => [
            'models'       => 'ScoreCheck/Models',
            'repositories' => 'ScoreCheck/Repositories',
            'interfaces'   => 'ScoreCheck/Repositories',
            'transformers' => 'ScoreCheck/Transformers',
            'presenters'   => 'ScoreCheck/Presenters',
            'validators'   => 'ScoreCheck/Validators',
